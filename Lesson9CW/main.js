...
for (const simpson of simpsons) {
    ...
    divEl.innerText = `${simpson.name} ${simpson.surname} ${simpson.age}`;
...
for (const simpson of simpsons) {
    ...
    divInfo =simpson.info;

    let divPhoto = document.createElement('div');
    divPhoto.innerText = simpson.photo;

    divEl2.append(divName);
    divEl2.append(divSurname);
    divEl2.append(divAge);
    divEl2.append(divInfo);
    divEl2.append(divPhoto)
